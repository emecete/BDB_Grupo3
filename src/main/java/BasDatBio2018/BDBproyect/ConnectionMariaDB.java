...
public class ConnectionMariaDB extends ConnectionAbstract {
	...
	public ConnectionMariaDB(boolean opt) {
		super(opt);
		conn=null;
		stmt=null;
		rs=null;
		...
		try {
			...
			if(opt == true) {
            	...
            	bd = "bdb_sin_indices"; //aun vacio
            }
        	conn =
               DriverManager.getConnection("jdbc:mariadb://localhost:3306/"+ bd +"?" +
                                           "user=emecete&password=maria300797&useSSL=false&serverTimezone=UTC");
